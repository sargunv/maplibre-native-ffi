...
progress through runtime events, change download state, inspect region status,
update metadata, merge side databases, invalidate cached resources, and delete
regions.
